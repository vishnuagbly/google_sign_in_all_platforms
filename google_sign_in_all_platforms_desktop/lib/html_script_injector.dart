...
class HtmlScriptInjector {
  static const String _scriptAssetPath =
      'packages/google_sign_in_all_platforms_desktop/assets/google_auth_script.js';
  ...
  static void _validateHtml(String authPage) {
    ...
    for (final tag in importantTags) {
      ...
      if (openCount != closeCount && openCount > 0) {
        ...
        print(
            'Warning: Potentially unmatched $tag tags (open: $openCount, close: $closeCount)');
      }
    }
  }
